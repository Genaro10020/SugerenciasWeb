                ...
                <!--BARRA SUPERIOR-->
                            ...
                            <!--style="box-shadow: 0px 0px 10px -2px black"-->
                                <div class="col-2 align-items-center rounded-end" style=" height:45.8833px;"><img class="img-fluid" src="img/logo_gonher.png"></img></div>
                                    <div class="col-8 d-flex align-items-center justify-content-center">
                                                <div>
                                                    <div class="titulo lh-1 mt-3 text-dark fs-2 fw-bold text-center" >Tomar Fotografía</div>
                    ...
                    <div class="row cuerpo" style="min-height:80vh; font-size: 0.9em; display: flex; justify-content: center; align-items: center;">
                                ...
                                <div class="col-12 " style="margin-top:10%">     
                                    ...
                                    <div class="col-12 offset-lg-4 col-lg-4 d-flex justify-content-center">
                                        <label class="alert alert-info mt-1" style="font-size:0.8em">Presione el bóton para Activar la Cámara y tomar la evidencia.</label>
                                    </div>
                                </div>                   
