...
?>
    ...
    <head>
        ...
        <!--Incluyendo Estilo-->
        <link rel="stylesheet" type="text/css" href="estilos/miestilo.css?v=10.">
        <!--Iconos boostrap-->
        ...
        <div id="app" class="container-fluid  "><!--BODY-->
            ...
            <div class="row  d-flex justify-content-around align-items-center" style="height:10vh; background-color: rgba(181,0,0,1); box-shadow: 0px 0px 12px -2px black;">
                <div class="row align-items-center bg-white">
                    ...
                    <div class="col-2 align-items-center rounded-end" style=" height:45.8833px;"><img class="img-fluid" src="img/logo_gonher.png"></img></div>
                    <div class="col-8 d-flex align-items-center justify-content-center">
                        <div>
                            <div class="titulo lh-1 mt-3 text-dark fs-2 fw-bold text-center">Dictado por Voz</div>
            ...
            <!--CUERPO-->
            <div class="row cuerpo" style="min-height:80vh; font-size: 0.9em; display: flex; justify-content: center; align-items: center;">

                <div class="col-12 " style="margin-top:10%">
                    <div class="col-12 d-flex justify-content-center">
                        <img class="img-fluid" src="img/grabando_voz.gif"></img>
                    </div>
                </div>
                <div class="col-12 d-flex justify-content-center">
                    <label class="alert alert-info mt-1" style="font-size:0.8em">Dicta tu hallazgo</label>
                </div>
            </div>
