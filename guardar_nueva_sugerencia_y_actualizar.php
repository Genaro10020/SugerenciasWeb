...
include "conexionGhoner.php";
    if($tipo=="nueva"){
        ...
        VALUES ('$cumplimiento','$sindicalizado_empleado','$nombre_sugerencia','$folio','$status', '$causa_no_factibilidad','$situacion_actual','$idea_propuesta','$nomina','$colaborador','$puesto','$planta','$area','$area_participante',
        ...
        $consulta= "UPDATE concentrado_sugerencias SET sindicalizado_empleado='$sindicalizado_empleado', nombre_sugerencia='$nombre_sugerencia', folio = '$folio', status = '$status', causa_no_factibilidad = '$causa_no_factibilidad', 
