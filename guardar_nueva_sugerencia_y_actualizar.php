...
include "conexionGhoner.php";
    if($tipo=="nueva"){
        ...
        fecha_de_inicio = '$fecha_inicio', fecha_compromiso = '$fecha_compromiso', fecha_real_cierre =  '$fecha_real_de_cierre', analista_de_factibilidad  = '$analista_de_factibilidad', 
