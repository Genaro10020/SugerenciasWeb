...
include "conexionGhoner.php";
        ...
        if($tipo=="nuevo"){
                $consulta = "INSERT INTO plan_trabajo_sugerencias (num_actividad,folio,actividad,responsable,fecha_inicial,fecha_final,porcentaje,check_mejora_continua)  VALUES ('$numero_actividad','$folio','$actividad','$responsable_plan','$fecha_inicial','$fecha_final','0','PENDIENTE')";
